...
from pytorch_lightning import seed_everything # pip install pytorch_lightning
from streamlit_helpers import *


# put the checkpoints and yaml file both in checkpoints/ 
...
VERSION2SPECS = {
    "SDXL-base-1.0": {
        ...
        "C": 4,
        "f": 8,
        "is_legacy": False, # models\checkpoints\sd_xl_base.yaml
        "config": "models/checkpoints/sd_xl_base.yaml",
    ...
    "SDXL-base-0.9": {
        ...
        "is_legacy": False,
        "config": "models/checkpoints/sd_xl_base.yaml",
        "ckpt": "models/checkpoints/sd_xl_base_0.9.safetensors",
    },
    "SD-2.1": {
        "H": 512,
        "W": 512,
        ...
        "f": 8,
        "is_legacy": True,
        "config": "models/checkpoints/sd_2_1.yaml",
        "ckpt": "models/checkpoints/v2-1_512-ema-pruned.safetensors",
    },
    "SD-2.1-768": {
        "H": 768,
        "W": 768,
        ...
        "f": 8,
        "is_legacy": True,
        "config": "models/checkpoints/sd_2_1_768.yaml",
        "ckpt": "models/checkpoints/v2-1_768-ema-pruned.safetensors",
    },
    "SDXL-refiner-0.9": {
        "H": 1024,
        "W": 1024,
        ...
        "f": 8,
        "is_legacy": True,
        "config": "models/checkpoints/sd_xl_refiner.yaml",
        "ckpt": "models/checkpoints/sd_xl_refiner_0.9.safetensors",
    },
    "SDXL-refiner-1.0": {
        "H": 1024,
        "W": 1024,
        ...
        "f": 8,
        "is_legacy": True,
        "config": "checkpoints/sd_xl_refiner.yaml",
